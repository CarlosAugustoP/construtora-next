...
export default function Intro() {
    ...
    return (
        <Wrapper>
            <StyledImg src={isScreenBiggerThan942px ? "img/hero2.jpeg" : "img/hero2.jpeg"} srcSet={isScreenBiggerThan942px ? "img/hero2.jpeg 942w" : "img/hero2.jpeg 942w"} alt="Parallax" />
            <ContentBox>
