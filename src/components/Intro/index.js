...
export default function Intro() {
    ...
    return (
        <Wrapper>
            <StyledImg src={isScreenBiggerThan942px ? "img/porenquanto.jpeg" : "img/porenquanto.jpeg"} srcSet={isScreenBiggerThan942px ? "img/porenquanto.jpeg 942w" : "img/porenquanto.jpeg 942w"} alt="Parallax" />
            <ContentBox>
